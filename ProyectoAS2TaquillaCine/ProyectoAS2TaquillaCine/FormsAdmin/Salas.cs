...
namespace ProyectoAS2TaquillaCine.FormsAdmin
{
    public partial class Salas : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            dataGridView1.Rows[rowIndex].Cells[0].Value = txtnosala.Text;
            dataGridView1.Rows[rowIndex].Cells[1].Value = txtcapacidad.Text;
            dataGridView1.Rows[rowIndex].Cells[2].Value = cbtiposala.Text;
            dataGridView1.Rows[rowIndex].Cells[3].Value = cbubicacion.Text;
            dataGridView1.Rows[rowIndex].Cells[4].Value = cbestado.Text;
        }
