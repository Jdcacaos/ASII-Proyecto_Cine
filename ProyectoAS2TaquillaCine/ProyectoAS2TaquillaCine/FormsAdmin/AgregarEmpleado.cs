...
namespace ProyectoAS2TaquillaCine.FormsAdmin
{
    public partial class AgregarEmpleado : Form
    {
        ...
        {
            string query = "SELECT nombre, apellido, email, telefono, FK_ID_Cargo, Contrasena FROM tbl_empleado";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Por favor, selecciona un cargo.", "Error de selección", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
